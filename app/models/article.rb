class Article < ApplicationRecord
  ...
  has_many :comments, dependen: :destroy # Adiciona relacionamento com Comment e define que ao deletar um Article, os Comments relacionados também serão deletados
